...
:::tip
You may also create the botlet for an existing product in the [Service Market](https://botlet.io/market). Just following it's instructions to fill in your own authentication tokens to enable it.
:::
