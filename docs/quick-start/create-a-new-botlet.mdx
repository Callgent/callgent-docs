...
This is achieved by adding a `Callable Plugin` to the botlet, then do some neccessary configurations. You may learn more in the [Client Endpoint](../advanced-topics/botlet-endpoints/client-endpoint) section.
