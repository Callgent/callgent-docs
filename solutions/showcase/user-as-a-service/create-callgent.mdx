...
<CascadingMenu adaptorKey="email" />
...
A **server endpoint** defines a method that can be invoked by the system, which gives reply to the user request. We can have multiple server endpoints, they can also be of different types:
1. Email type
2. Restapi type
3. Webhook type
4. Glue code type
